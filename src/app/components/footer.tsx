        ...
        <footer className="bg-black text-white py-8 px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-4 gap-6 border-b border-gray-700 pb-8">
                ...
                <div className="flex justify-start lg:justify-end items-start gap-4">
                    {/* Social Media Links */}
                    <Link href='https://blog.x.com/en_us/topics/product/2019/introducing-a-new-Twitter-dot-com'>
                    <FaTwitter className="text-lg cursor-pointer hover:text-gray-400" /></Link>
                    <Link href='https://www.facebook.com/'><FaFacebook className="text-lg cursor-pointer hover:text-gray-400" /></Link>
                    <Link href='https://www.youtube.com/'><FaYoutube className="text-lg cursor-pointer hover:text-gray-400" /></Link>
                    <Link href='https://www.instagram.com/'><FaInstagram className="text-lg cursor-pointer hover:text-gray-400" /></Link>
                </div>
            </div>
